    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          ...
          <!-- Seções do conteúdo -->
      <div id="cadastro" class="content-section bg-dark text-white min-vh-100" style="display: none;">
        ...
        <form class="bg-dark p-4 rounded border border-secondary text-white">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <button type="button" class="input-group-text bg-secondary text-white">
